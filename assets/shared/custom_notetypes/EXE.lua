function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'EXE' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'noteskins/EXENotes'); --Change texture
