...
function onCreate()
	...
	--MAIN SECTION
	makeLuaSprite('Main', 'stages/personel/CREDITTEXT', ((screenWidth/2)-(570/2)) +- HorizontalUnderLayOffset, -1300)
	...
	--BorderLeft
	makeLuaSprite('BorderLeft', 'stages/personel/OUTLINE', (((screenWidth/2)-(4/2)) - 285) +- HorizontalUnderLayOffset, -1300)
	...
	--BorderRight
	makeLuaSprite('BorderRight', 'stages/personel/OUTLINE', (((screenWidth/2)-(4/2)) + 285) +- HorizontalUnderLayOffset, -1300)
